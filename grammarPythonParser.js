// Generated from grammarPythonParser.g4 by ANTLR 4.10.1
// jshint ignore: start
...
export default class grammarPythonParser extends antlr4.Parser {
    ...
    static grammarFileName = "grammarPythonParser.g4";
	...
	single_input() {
	    ...
	    this.enterRule(localctx, 0, grammarPythonParser.RULE_single_input);
	    try {
	        this.state = 177;
	        this._errHandler.sync(this);
	        switch(this._input.LA(1)) {
	        case grammarPythonParser.NEWLINE:
	            this.enterOuterAlt(localctx, 1);
	            this.state = 172;
	            this.match(grammarPythonParser.NEWLINE);
	            break;
	        case grammarPythonParser.STRING:
	        case grammarPythonParser.NUMBER:
	        case grammarPythonParser.RETURN:
	        case grammarPythonParser.RAISE:
	        case grammarPythonParser.FROM:
	        case grammarPythonParser.IMPORT:
	        case grammarPythonParser.GLOBAL:
	        case grammarPythonParser.NONLOCAL:
	        case grammarPythonParser.ASSERT:
	        case grammarPythonParser.LAMBDA:
	        case grammarPythonParser.NOT:
	        case grammarPythonParser.NONE:
	        case grammarPythonParser.TRUE:
	        case grammarPythonParser.FALSE:
	        case grammarPythonParser.YIELD:
	        case grammarPythonParser.DEL:
	        case grammarPythonParser.PASS:
	        case grammarPythonParser.CONTINUE:
	        case grammarPythonParser.BREAK:
	        case grammarPythonParser.AWAIT:
	        case grammarPythonParser.NAME:
	        case grammarPythonParser.ELLIPSIS:
	        case grammarPythonParser.STAR:
	        case grammarPythonParser.OPEN_PAREN:
	        case grammarPythonParser.OPEN_BRACK:
	        case grammarPythonParser.ADD:
	        case grammarPythonParser.MINUS:
	        case grammarPythonParser.NOT_OP:
	        case grammarPythonParser.OPEN_BRACE:
	            this.enterOuterAlt(localctx, 2);
	            this.state = 173;
	            this.simple_stmt();
	            break;
	        case grammarPythonParser.DEF:
	        case grammarPythonParser.IF:
	        case grammarPythonParser.WHILE:
	        case grammarPythonParser.FOR:
	        case grammarPythonParser.TRY:
	        case grammarPythonParser.WITH:
	        case grammarPythonParser.CLASS:
	        case grammarPythonParser.ASYNC:
	        case grammarPythonParser.AT:
	...
	file_input() {
	    ...
	    this.enterRule(localctx, 2, grammarPythonParser.RULE_file_input);
	    ...
	    try {
	        ...
	        while((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << grammarPythonParser.STRING) | (1 << grammarPythonParser.NUMBER) | (1 << grammarPythonParser.DEF) | (1 << grammarPythonParser.RETURN) | (1 << grammarPythonParser.RAISE) | (1 << grammarPythonParser.FROM) | (1 << grammarPythonParser.IMPORT) | (1 << grammarPythonParser.GLOBAL) | (1 << grammarPythonParser.NONLOCAL) | (1 << grammarPythonParser.ASSERT) | (1 << grammarPythonParser.IF) | (1 << grammarPythonParser.WHILE) | (1 << grammarPythonParser.FOR) | (1 << grammarPythonParser.TRY) | (1 << grammarPythonParser.WITH) | (1 << grammarPythonParser.LAMBDA) | (1 << grammarPythonParser.NOT) | (1 << grammarPythonParser.NONE) | (1 << grammarPythonParser.TRUE))) !== 0) || ((((_la - 32)) & ~0x1f) == 0 && ((1 << (_la - 32)) & ((1 << (grammarPythonParser.FALSE - 32)) | (1 << (grammarPythonParser.CLASS - 32)) | (1 << (grammarPythonParser.YIELD - 32)) | (1 << (grammarPythonParser.DEL - 32)) | (1 << (grammarPythonParser.PASS - 32)) | (1 << (grammarPythonParser.CONTINUE - 32)) | (1 << (grammarPythonParser.BREAK - 32)) | (1 << (grammarPythonParser.ASYNC - 32)) | (1 << (grammarPythonParser.AWAIT - 32)) | (1 << (grammarPythonParser.NEWLINE - 32)) | (1 << (grammarPythonParser.NAME - 32)) | (1 << (grammarPythonParser.ELLIPSIS - 32)) | (1 << (grammarPythonParser.STAR - 32)) | (1 << (grammarPythonParser.OPEN_PAREN - 32)) | (1 << (grammarPythonParser.OPEN_BRACK - 32)))) !== 0) || ((((_la - 68)) & ~0x1f) == 0 && ((1 << (_la - 68)) & ((1 << (grammarPythonParser.ADD - 68)) | (1 << (grammarPythonParser.MINUS - 68)) | (1 << (grammarPythonParser.NOT_OP - 68)) | (1 << (grammarPythonParser.OPEN_BRACE - 68)) | (1 << (grammarPythonParser.AT - 68)))) !== 0)) {
	            this.state = 181;
	            this._errHandler.sync(this);
	            switch(this._input.LA(1)) {
	            case grammarPythonParser.NEWLINE:
	        ...
	        this.state = 186;
	        this.match(grammarPythonParser.EOF);
	    } catch (re) {
	    	if(re instanceof antlr4.error.RecognitionException) {
		        localctx.exception = re;
		        this._errHandler.reportError(this, re);
	...
	eval_input() {
	    ...
	    this.enterRule(localctx, 4, grammarPythonParser.RULE_eval_input);
	    var _la = 0; // Token type
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 188;
	        ...
	        this._errHandler.sync(this);
	        _la = this._input.LA(1);
	        while(_la===grammarPythonParser.NEWLINE) {
	            this.state = 189;
	            this.match(grammarPythonParser.NEWLINE);
	            this.state = 194;
	            this._errHandler.sync(this);
	...
	decorator() {
	    ...
	    this.enterRule(localctx, 6, grammarPythonParser.RULE_decorator);
	    var _la = 0; // Token type
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 197;
	        this.match(grammarPythonParser.AT);
	        this.state = 198;
	        this.dotted_name();
	        this.state = 204;
	        this._errHandler.sync(this);
	        _la = this._input.LA(1);
	        if(_la===grammarPythonParser.OPEN_PAREN) {
	            this.state = 199;
	            this.match(grammarPythonParser.OPEN_PAREN);
	            this.state = 201;
	            this._errHandler.sync(this);
	            _la = this._input.LA(1);
	            if((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << grammarPythonParser.STRING) | (1 << grammarPythonParser.NUMBER) | (1 << grammarPythonParser.LAMBDA) | (1 << grammarPythonParser.NOT) | (1 << grammarPythonParser.NONE) | (1 << grammarPythonParser.TRUE))) !== 0) || ((((_la - 32)) & ~0x1f) == 0 && ((1 << (_la - 32)) & ((1 << (grammarPythonParser.FALSE - 32)) | (1 << (grammarPythonParser.AWAIT - 32)) | (1 << (grammarPythonParser.NAME - 32)) | (1 << (grammarPythonParser.ELLIPSIS - 32)) | (1 << (grammarPythonParser.STAR - 32)) | (1 << (grammarPythonParser.OPEN_PAREN - 32)) | (1 << (grammarPythonParser.POWER - 32)) | (1 << (grammarPythonParser.OPEN_BRACK - 32)))) !== 0) || ((((_la - 68)) & ~0x1f) == 0 && ((1 << (_la - 68)) & ((1 << (grammarPythonParser.ADD - 68)) | (1 << (grammarPythonParser.MINUS - 68)) | (1 << (grammarPythonParser.NOT_OP - 68)) | (1 << (grammarPythonParser.OPEN_BRACE - 68)))) !== 0)) {
	                this.state = 200;
	                this.arglist();
	            }

	            this.state = 203;
	            this.match(grammarPythonParser.CLOSE_PAREN);
	        }
	...
	decorators() {
	    ...
	    this.enterRule(localctx, 8, grammarPythonParser.RULE_decorators);
	    var _la = 0; // Token type
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 209; 
	        ...
	        do {
	            ...
	            this._errHandler.sync(this);
	            _la = this._input.LA(1);
	        } while(_la===grammarPythonParser.AT);
	    } catch (re) {
	    	if(re instanceof antlr4.error.RecognitionException) {
		        localctx.exception = re;
		        this._errHandler.reportError(this, re);
	...
	decorated() {
	    ...
	    this.enterRule(localctx, 10, grammarPythonParser.RULE_decorated);
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 213;
	        this.decorators();
	...
	async_funcdef() {
	    ...
	    this.enterRule(localctx, 12, grammarPythonParser.RULE_async_funcdef);
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 219;
	        this.match(grammarPythonParser.ASYNC);
	        this.state = 220;
	        this.funcdef();
	    } catch (re) {
	    	if(re instanceof antlr4.error.RecognitionException) {
	...
	funcdef() {
	    ...
	    this.enterRule(localctx, 14, grammarPythonParser.RULE_funcdef);
	    var _la = 0; // Token type
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 222;
	        this.match(grammarPythonParser.DEF);
	        this.state = 223;
	        this.match(grammarPythonParser.NAME);
	        this.state = 224;
	        this.parameters();
	        this.state = 227;
	        this._errHandler.sync(this);
	        _la = this._input.LA(1);
	        if(_la===grammarPythonParser.ARROW) {
	            this.state = 225;
	            this.match(grammarPythonParser.ARROW);
	            this.state = 226;
	            this.test();
	        }

	        this.state = 229;
	        this.match(grammarPythonParser.COLON);
	        this.state = 230;
	        this.suite();
	    } catch (re) {
	    	if(re instanceof antlr4.error.RecognitionException) {
	...
	parameters() {
	    ...
	    this.enterRule(localctx, 16, grammarPythonParser.RULE_parameters);
	    var _la = 0; // Token type
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 232;
	        ...
	        this._errHandler.sync(this);
	        _la = this._input.LA(1);
	        if(((((_la - 42)) & ~0x1f) == 0 && ((1 << (_la - 42)) & ((1 << (grammarPythonParser.NAME - 42)) | (1 << (grammarPythonParser.STAR - 42)) | (1 << (grammarPythonParser.POWER - 42)))) !== 0)) {
	            this.state = 233;
	            this.typedargslist();
	        }
	...
	typedargslist() {
	    ...
	    this.enterRule(localctx, 18, grammarPythonParser.RULE_typedargslist);
	    var _la = 0; // Token type
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 319;
	        ...
	        case grammarPythonParser.NAME:
	            ...
	            this._errHandler.sync(this);
	            _la = this._input.LA(1);
	            if(_la===grammarPythonParser.ASSIGN) {
	                this.state = 239;
	                this.match(grammarPythonParser.ASSIGN);
	                this.state = 240;
	                this.test();
	            }
	            ...
	            this._errHandler.sync(this);
	            _la = this._input.LA(1);
	            if(_la===grammarPythonParser.COMMA) {
	                this.state = 254;
	                this.match(grammarPythonParser.COMMA);
	                this.state = 285;
	                this._errHandler.sync(this);
	                ...
	                case grammarPythonParser.STAR:
	                	this.state = 255;
	                	this.match(grammarPythonParser.STAR);
	                	this.state = 257;
	                	this._errHandler.sync(this);
	                	_la = this._input.LA(1);
	                	if(_la===grammarPythonParser.NAME) {
	                	    this.state = 256;
	                	    this.tfpdef();
	                	}
	                	...
	                	if(_la===grammarPythonParser.COMMA) {
	                	    ...
	                	    this._errHandler.sync(this);
	                	    _la = this._input.LA(1);
	                	    if(_la===grammarPythonParser.POWER) {
	                	        this.state = 271;
	                	        this.match(grammarPythonParser.POWER);
	                	        this.state = 272;
	                	        this.tfpdef();
	                	        this.state = 274;
	                	        this._errHandler.sync(this);
	                	...
	                	break;
	                case grammarPythonParser.POWER:
	                	this.state = 280;
	                	this.match(grammarPythonParser.POWER);
	                	this.state = 281;
	                	this.tfpdef();
	                	...
	                	break;
	                case grammarPythonParser.CLOSE_PAREN:
	                	break;
	                default:
	                	break;
	                }
	...
	tfpdef() {
	    ...
	    this.enterRule(localctx, 20, grammarPythonParser.RULE_tfpdef);
	    var _la = 0; // Token type
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 321;
	        ...
	        this._errHandler.sync(this);
	        _la = this._input.LA(1);
	        if(_la===grammarPythonParser.COLON) {
	            this.state = 322;
	            this.match(grammarPythonParser.COLON);
	            this.state = 323;
	            this.test();
	...
	varargslist() {
	    ...
	    this.enterRule(localctx, 22, grammarPythonParser.RULE_varargslist);
	    var _la = 0; // Token type
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 407;
	        ...
	        case grammarPythonParser.NAME:
	            ...
	            if(_la===grammarPythonParser.COMMA) {
	                ...
	                case grammarPythonParser.POWER:
	                	...
	                	break;
	                case grammarPythonParser.COLON:
	                	break;
	                default:
	                	break;
	                }
	...
	vfpdef() {
	    ...
	    this.enterRule(localctx, 24, grammarPythonParser.RULE_vfpdef);
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 409;
	        this.match(grammarPythonParser.NAME);
	...
	stmt() {
	    ...
	    this.enterRule(localctx, 26, grammarPythonParser.RULE_stmt);
	    try {
	        this.state = 413;
	        this._errHandler.sync(this);
	        switch(this._input.LA(1)) {
	...
	simple_stmt() {
	    ...
	    this.enterRule(localctx, 28, grammarPythonParser.RULE_simple_stmt);
	    var _la = 0; // Token type
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 415;
	        ...
	        while(_alt!=2 && _alt!=antlr4.atn.ATN.INVALID_ALT_NUMBER) {
	            if(_alt===1) {
	                this.state = 416;
	                this.match(grammarPythonParser.SEMI_COLON);
	                this.state = 417;
	                this.small_stmt(); 
	            }
	            this.state = 422;
	        ...
	        this._errHandler.sync(this);
	        _la = this._input.LA(1);
	        if(_la===grammarPythonParser.SEMI_COLON) {
	            this.state = 423;
	            this.match(grammarPythonParser.SEMI_COLON);
	        }
	...
	small_stmt() {
	    ...
	    this.enterRule(localctx, 30, grammarPythonParser.RULE_small_stmt);
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 436;
	        this._errHandler.sync(this);
	...
	expr_stmt() {
	    ...
	    this.enterRule(localctx, 32, grammarPythonParser.RULE_expr_stmt);
	    var _la = 0; // Token type
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 438;
	        ...
	        case grammarPythonParser.COLON:
	            ...
	            this.annassign();
	            break;
	        case grammarPythonParser.ADD_ASSIGN:
	        case grammarPythonParser.SUB_ASSIGN:
	        case grammarPythonParser.MULT_ASSIGN:
	        case grammarPythonParser.AT_ASSIGN:
	        case grammarPythonParser.DIV_ASSIGN:
	        case grammarPythonParser.MOD_ASSIGN:
	        case grammarPythonParser.AND_ASSIGN:
	        case grammarPythonParser.OR_ASSIGN:
	        case grammarPythonParser.XOR_ASSIGN:
	        case grammarPythonParser.LEFT_SHIFT_ASSIGN:
	        case grammarPythonParser.RIGHT_SHIFT_ASSIGN:
	        case grammarPythonParser.POWER_ASSIGN:
	        case grammarPythonParser.IDIV_ASSIGN:
	            this.state = 440;
	            this.augassign();
	            this.state = 443;
	            this._errHandler.sync(this);
	            ...
	            break;
	        case grammarPythonParser.NEWLINE:
	        case grammarPythonParser.SEMI_COLON:
	        case grammarPythonParser.ASSIGN:
	            this.state = 452;
	            this._errHandler.sync(this);
	            _la = this._input.LA(1);
	            while(_la===grammarPythonParser.ASSIGN) {
	                this.state = 445;
	                this.match(grammarPythonParser.ASSIGN);
	                this.state = 448;
	                this._errHandler.sync(this);
	...
	annassign() {
	    ...
	    this.enterRule(localctx, 34, grammarPythonParser.RULE_annassign);
	    var _la = 0; // Token type
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 457;
	...
	testlist_star_expr() {
	    ...
	    this.enterRule(localctx, 36, grammarPythonParser.RULE_testlist_star_expr);
	    var _la = 0; // Token type
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 465;
	...
	augassign() {
	    ...
	    this.enterRule(localctx, 38, grammarPythonParser.RULE_augassign);
	    var _la = 0; // Token type
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 480;
	        _la = this._input.LA(1);
	        if(!(((((_la - 85)) & ~0x1f) == 0 && ((1 << (_la - 85)) & ((1 << (grammarPythonParser.ADD_ASSIGN - 85)) | (1 << (grammarPythonParser.SUB_ASSIGN - 85)) | (1 << (grammarPythonParser.MULT_ASSIGN - 85)) | (1 << (grammarPythonParser.AT_ASSIGN - 85)) | (1 << (grammarPythonParser.DIV_ASSIGN - 85)) | (1 << (grammarPythonParser.MOD_ASSIGN - 85)) | (1 << (grammarPythonParser.AND_ASSIGN - 85)) | (1 << (grammarPythonParser.OR_ASSIGN - 85)) | (1 << (grammarPythonParser.XOR_ASSIGN - 85)) | (1 << (grammarPythonParser.LEFT_SHIFT_ASSIGN - 85)) | (1 << (grammarPythonParser.RIGHT_SHIFT_ASSIGN - 85)) | (1 << (grammarPythonParser.POWER_ASSIGN - 85)) | (1 << (grammarPythonParser.IDIV_ASSIGN - 85)))) !== 0))) {
	...
	del_stmt() {
	    ...
	    this.enterRule(localctx, 40, grammarPythonParser.RULE_del_stmt);
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 482;
	        this.match(grammarPythonParser.DEL);
	        this.state = 483;
	        this.exprlist();
	    } catch (re) {
	    	if(re instanceof antlr4.error.RecognitionException) {
	...
	pass_stmt() {
	    ...
	    this.enterRule(localctx, 42, grammarPythonParser.RULE_pass_stmt);
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 485;
	        this.match(grammarPythonParser.PASS);
	    } catch (re) {
	    	if(re instanceof antlr4.error.RecognitionException) {
		        localctx.exception = re;
		        this._errHandler.reportError(this, re);
	...
	flow_stmt() {
	    ...
	    this.enterRule(localctx, 44, grammarPythonParser.RULE_flow_stmt);
	    try {
	        this.state = 492;
	        this._errHandler.sync(this);
	        switch(this._input.LA(1)) {
	...
	break_stmt() {
	    ...
	    this.enterRule(localctx, 46, grammarPythonParser.RULE_break_stmt);
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 494;
	        this.match(grammarPythonParser.BREAK);
	    } catch (re) {
	    	if(re instanceof antlr4.error.RecognitionException) {
		        localctx.exception = re;
		        this._errHandler.reportError(this, re);
	...
	continue_stmt() {
	    ...
	    this.enterRule(localctx, 48, grammarPythonParser.RULE_continue_stmt);
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 496;
	        this.match(grammarPythonParser.CONTINUE);
	    } catch (re) {
	    	if(re instanceof antlr4.error.RecognitionException) {
		        localctx.exception = re;
		        this._errHandler.reportError(this, re);
	...
	return_stmt() {
	    ...
	    this.enterRule(localctx, 50, grammarPythonParser.RULE_return_stmt);
	    var _la = 0; // Token type
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 498;
	        this.match(grammarPythonParser.RETURN);
	        this.state = 500;
	        this._errHandler.sync(this);
	        _la = this._input.LA(1);
	        if((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << grammarPythonParser.STRING) | (1 << grammarPythonParser.NUMBER) | (1 << grammarPythonParser.LAMBDA) | (1 << grammarPythonParser.NOT) | (1 << grammarPythonParser.NONE) | (1 << grammarPythonParser.TRUE))) !== 0) || ((((_la - 32)) & ~0x1f) == 0 && ((1 << (_la - 32)) & ((1 << (grammarPythonParser.FALSE - 32)) | (1 << (grammarPythonParser.AWAIT - 32)) | (1 << (grammarPythonParser.NAME - 32)) | (1 << (grammarPythonParser.ELLIPSIS - 32)) | (1 << (grammarPythonParser.OPEN_PAREN - 32)) | (1 << (grammarPythonParser.OPEN_BRACK - 32)))) !== 0) || ((((_la - 68)) & ~0x1f) == 0 && ((1 << (_la - 68)) & ((1 << (grammarPythonParser.ADD - 68)) | (1 << (grammarPythonParser.MINUS - 68)) | (1 << (grammarPythonParser.NOT_OP - 68)) | (1 << (grammarPythonParser.OPEN_BRACE - 68)))) !== 0)) {
	            this.state = 499;
	            this.testlist();
	        }
	...
	yield_stmt() {
	    ...
	    this.enterRule(localctx, 52, grammarPythonParser.RULE_yield_stmt);
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 502;
	        this.yield_expr();
	...
	raise_stmt() {
	    ...
	    this.enterRule(localctx, 54, grammarPythonParser.RULE_raise_stmt);
	    var _la = 0; // Token type
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 504;
	        this.match(grammarPythonParser.RAISE);
	        this.state = 510;
	        this._errHandler.sync(this);
	        _la = this._input.LA(1);
	        if((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << grammarPythonParser.STRING) | (1 << grammarPythonParser.NUMBER) | (1 << grammarPythonParser.LAMBDA) | (1 << grammarPythonParser.NOT) | (1 << grammarPythonParser.NONE) | (1 << grammarPythonParser.TRUE))) !== 0) || ((((_la - 32)) & ~0x1f) == 0 && ((1 << (_la - 32)) & ((1 << (grammarPythonParser.FALSE - 32)) | (1 << (grammarPythonParser.AWAIT - 32)) | (1 << (grammarPythonParser.NAME - 32)) | (1 << (grammarPythonParser.ELLIPSIS - 32)) | (1 << (grammarPythonParser.OPEN_PAREN - 32)) | (1 << (grammarPythonParser.OPEN_BRACK - 32)))) !== 0) || ((((_la - 68)) & ~0x1f) == 0 && ((1 << (_la - 68)) & ((1 << (grammarPythonParser.ADD - 68)) | (1 << (grammarPythonParser.MINUS - 68)) | (1 << (grammarPythonParser.NOT_OP - 68)) | (1 << (grammarPythonParser.OPEN_BRACE - 68)))) !== 0)) {
	            ...
	            this._errHandler.sync(this);
	            _la = this._input.LA(1);
	            if(_la===grammarPythonParser.FROM) {
	                this.state = 506;
	                this.match(grammarPythonParser.FROM);
	                this.state = 507;
	                this.test();
	            }
	...
	import_stmt() {
	    ...
	    this.enterRule(localctx, 56, grammarPythonParser.RULE_import_stmt);
	    try {
	        this.state = 514;
	        this._errHandler.sync(this);
	        switch(this._input.LA(1)) {
	...
	import_name() {
	    ...
	    this.enterRule(localctx, 58, grammarPythonParser.RULE_import_name);
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 516;
	        this.match(grammarPythonParser.IMPORT);
	        this.state = 517;
	...
	import_from() {
	    ...
	    this.enterRule(localctx, 60, grammarPythonParser.RULE_import_from);
	    var _la = 0; // Token type
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 519;
	        ...
	        case 1:
	            ...
	            this._errHandler.sync(this);
	            _la = this._input.LA(1);
	            while(_la===grammarPythonParser.DOT || _la===grammarPythonParser.ELLIPSIS) {
	                this.state = 520;
	                _la = this._input.LA(1);
	                if(!(_la===grammarPythonParser.DOT || _la===grammarPythonParser.ELLIPSIS)) {
	                this._errHandler.recoverInline(this);
	                }
	                else {
	                	this._errHandler.reportMatch(this);
	...
	import_as_name() {
	    ...
	    this.enterRule(localctx, 62, grammarPythonParser.RULE_import_as_name);
	    var _la = 0; // Token type
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 543;
	        ...
	        this._errHandler.sync(this);
	        _la = this._input.LA(1);
	        if(_la===grammarPythonParser.AS) {
	            this.state = 544;
	            this.match(grammarPythonParser.AS);
	            this.state = 545;
	            this.match(grammarPythonParser.NAME);
	        }
	...
	dotted_as_name() {
	    ...
	    this.enterRule(localctx, 64, grammarPythonParser.RULE_dotted_as_name);
	    var _la = 0; // Token type
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 548;
	...
	import_as_names() {
	    ...
	    this.enterRule(localctx, 66, grammarPythonParser.RULE_import_as_names);
	    var _la = 0; // Token type
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 553;
	...
	dotted_as_names() {
	    ...
	    this.enterRule(localctx, 68, grammarPythonParser.RULE_dotted_as_names);
	    var _la = 0; // Token type
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 564;
	...
	dotted_name() {
	    ...
	    this.enterRule(localctx, 70, grammarPythonParser.RULE_dotted_name);
	    var _la = 0; // Token type
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 572;
	        ...
	        this._errHandler.sync(this);
	        _la = this._input.LA(1);
	        while(_la===grammarPythonParser.DOT) {
	            this.state = 573;
	            this.match(grammarPythonParser.DOT);
	            this.state = 574;
	            this.match(grammarPythonParser.NAME);
	            this.state = 579;
	            this._errHandler.sync(this);
	...
	global_stmt() {
	    ...
	    this.enterRule(localctx, 72, grammarPythonParser.RULE_global_stmt);
	    var _la = 0; // Token type
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 580;
	        this.match(grammarPythonParser.GLOBAL);
	        this.state = 581;
	        this.match(grammarPythonParser.NAME);
	        this.state = 586;
	        this._errHandler.sync(this);
	...
	nonlocal_stmt() {
	    ...
	    this.enterRule(localctx, 74, grammarPythonParser.RULE_nonlocal_stmt);
	    var _la = 0; // Token type
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 589;
	        this.match(grammarPythonParser.NONLOCAL);
	        this.state = 590;
	        this.match(grammarPythonParser.NAME);
	        this.state = 595;
	        this._errHandler.sync(this);
	...
	assert_stmt() {
	    ...
	    this.enterRule(localctx, 76, grammarPythonParser.RULE_assert_stmt);
	    var _la = 0; // Token type
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 598;
	        this.match(grammarPythonParser.ASSERT);
	        this.state = 599;
	        this.test();
	        this.state = 602;
	        this._errHandler.sync(this);
	...
	compound_stmt() {
	    ...
	    this.enterRule(localctx, 78, grammarPythonParser.RULE_compound_stmt);
	    try {
	        this.state = 613;
	        this._errHandler.sync(this);
	        switch(this._input.LA(1)) {
	...
	async_stmt() {
	    ...
	    this.enterRule(localctx, 80, grammarPythonParser.RULE_async_stmt);
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 615;
	        this.match(grammarPythonParser.ASYNC);
	...
	if_stmt() {
	    ...
	    this.enterRule(localctx, 82, grammarPythonParser.RULE_if_stmt);
	    var _la = 0; // Token type
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 621;
	        this.match(grammarPythonParser.IF);
	        this.state = 622;
	        this.test();
	        this.state = 623;
	        this.match(grammarPythonParser.COLON);
	        ...
	        this._errHandler.sync(this);
	        _la = this._input.LA(1);
	        while(_la===grammarPythonParser.ELIF) {
	            this.state = 625;
	            this.match(grammarPythonParser.ELIF);
	            this.state = 626;
	            this.test();
	            this.state = 627;
	            this.match(grammarPythonParser.COLON);
	        ...
	        this._errHandler.sync(this);
	        _la = this._input.LA(1);
	        if(_la===grammarPythonParser.ELSE) {
	            this.state = 635;
	            this.match(grammarPythonParser.ELSE);
	            this.state = 636;
	            this.match(grammarPythonParser.COLON);
	            this.state = 637;
	            this.suite();
	...
	while_stmt() {
	    ...
	    this.enterRule(localctx, 84, grammarPythonParser.RULE_while_stmt);
	    var _la = 0; // Token type
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 640;
	        this.match(grammarPythonParser.WHILE);
	        this.state = 641;
	        this.test();
	        this.state = 642;
	        this.match(grammarPythonParser.COLON);
	...
	for_stmt() {
	    ...
	    this.enterRule(localctx, 86, grammarPythonParser.RULE_for_stmt);
	    var _la = 0; // Token type
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 649;
	        this.match(grammarPythonParser.FOR);
	        this.state = 650;
	        this.exprlist();
	        this.state = 651;
	        this.match(grammarPythonParser.IN);
	        this.state = 652;
	        this.testlist();
	        this.state = 653;
	        this.match(grammarPythonParser.COLON);
	...
	try_stmt() {
	    ...
	    this.enterRule(localctx, 88, grammarPythonParser.RULE_try_stmt);
	    var _la = 0; // Token type
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 660;
	        this.match(grammarPythonParser.TRY);
	        this.state = 661;
	        this.match(grammarPythonParser.COLON);
	        this.state = 662;
	        this.suite();
	        ...
	        this._errHandler.sync(this);
	        switch(this._input.LA(1)) {
	        case grammarPythonParser.EXCEPT:
	            this.state = 667; 
	            this._errHandler.sync(this);
	            _la = this._input.LA(1);
	            do {
	                ...
	                this._errHandler.sync(this);
	                _la = this._input.LA(1);
	            } while(_la===grammarPythonParser.EXCEPT);
	            this.state = 674;
	            this._errHandler.sync(this);
	            _la = this._input.LA(1);
	            if(_la===grammarPythonParser.ELSE) {
	            ...
	            this._errHandler.sync(this);
	            _la = this._input.LA(1);
	            if(_la===grammarPythonParser.FINALLY) {
	                this.state = 676;
	                this.match(grammarPythonParser.FINALLY);
	                this.state = 677;
	                this.match(grammarPythonParser.COLON);
	                this.state = 678;
	                this.suite();
	            ...
	            break;
	        case grammarPythonParser.FINALLY:
	            this.state = 681;
	            this.match(grammarPythonParser.FINALLY);
	            this.state = 682;
	            this.match(grammarPythonParser.COLON);
	...
	with_stmt() {
	    ...
	    this.enterRule(localctx, 90, grammarPythonParser.RULE_with_stmt);
	    var _la = 0; // Token type
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 686;
	        this.match(grammarPythonParser.WITH);
	        this.state = 687;
	        this.with_item();
	        this.state = 692;
	        this._errHandler.sync(this);
	...
	with_item() {
	    ...
	    this.enterRule(localctx, 92, grammarPythonParser.RULE_with_item);
	    var _la = 0; // Token type
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 698;
	...
	except_clause() {
	    ...
	    this.enterRule(localctx, 94, grammarPythonParser.RULE_except_clause);
	    var _la = 0; // Token type
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 703;
	        this.match(grammarPythonParser.EXCEPT);
	        this.state = 709;
	        this._errHandler.sync(this);
	        _la = this._input.LA(1);
	        if((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << grammarPythonParser.STRING) | (1 << grammarPythonParser.NUMBER) | (1 << grammarPythonParser.LAMBDA) | (1 << grammarPythonParser.NOT) | (1 << grammarPythonParser.NONE) | (1 << grammarPythonParser.TRUE))) !== 0) || ((((_la - 32)) & ~0x1f) == 0 && ((1 << (_la - 32)) & ((1 << (grammarPythonParser.FALSE - 32)) | (1 << (grammarPythonParser.AWAIT - 32)) | (1 << (grammarPythonParser.NAME - 32)) | (1 << (grammarPythonParser.ELLIPSIS - 32)) | (1 << (grammarPythonParser.OPEN_PAREN - 32)) | (1 << (grammarPythonParser.OPEN_BRACK - 32)))) !== 0) || ((((_la - 68)) & ~0x1f) == 0 && ((1 << (_la - 68)) & ((1 << (grammarPythonParser.ADD - 68)) | (1 << (grammarPythonParser.MINUS - 68)) | (1 << (grammarPythonParser.NOT_OP - 68)) | (1 << (grammarPythonParser.OPEN_BRACE - 68)))) !== 0)) {
	...
	suite() {
	    ...
	    this.enterRule(localctx, 96, grammarPythonParser.RULE_suite);
	    var _la = 0; // Token type
	    try {
	        this.state = 721;
	        this._errHandler.sync(this);
	        ...
	        case grammarPythonParser.NEWLINE:
	            ...
	            this.match(grammarPythonParser.NEWLINE);
	            this.state = 713;
	            this.match(grammarPythonParser.INDENT);
	            this.state = 715; 
	            this._errHandler.sync(this);
	            _la = this._input.LA(1);
	            do {
	                ...
	                this._errHandler.sync(this);
	                _la = this._input.LA(1);
	            } while((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << grammarPythonParser.STRING) | (1 << grammarPythonParser.NUMBER) | (1 << grammarPythonParser.DEF) | (1 << grammarPythonParser.RETURN) | (1 << grammarPythonParser.RAISE) | (1 << grammarPythonParser.FROM) | (1 << grammarPythonParser.IMPORT) | (1 << grammarPythonParser.GLOBAL) | (1 << grammarPythonParser.NONLOCAL) | (1 << grammarPythonParser.ASSERT) | (1 << grammarPythonParser.IF) | (1 << grammarPythonParser.WHILE) | (1 << grammarPythonParser.FOR) | (1 << grammarPythonParser.TRY) | (1 << grammarPythonParser.WITH) | (1 << grammarPythonParser.LAMBDA) | (1 << grammarPythonParser.NOT) | (1 << grammarPythonParser.NONE) | (1 << grammarPythonParser.TRUE))) !== 0) || ((((_la - 32)) & ~0x1f) == 0 && ((1 << (_la - 32)) & ((1 << (grammarPythonParser.FALSE - 32)) | (1 << (grammarPythonParser.CLASS - 32)) | (1 << (grammarPythonParser.YIELD - 32)) | (1 << (grammarPythonParser.DEL - 32)) | (1 << (grammarPythonParser.PASS - 32)) | (1 << (grammarPythonParser.CONTINUE - 32)) | (1 << (grammarPythonParser.BREAK - 32)) | (1 << (grammarPythonParser.ASYNC - 32)) | (1 << (grammarPythonParser.AWAIT - 32)) | (1 << (grammarPythonParser.NAME - 32)) | (1 << (grammarPythonParser.ELLIPSIS - 32)) | (1 << (grammarPythonParser.STAR - 32)) | (1 << (grammarPythonParser.OPEN_PAREN - 32)) | (1 << (grammarPythonParser.OPEN_BRACK - 32)))) !== 0) || ((((_la - 68)) & ~0x1f) == 0 && ((1 << (_la - 68)) & ((1 << (grammarPythonParser.ADD - 68)) | (1 << (grammarPythonParser.MINUS - 68)) | (1 << (grammarPythonParser.NOT_OP - 68)) | (1 << (grammarPythonParser.OPEN_BRACE - 68)) | (1 << (grammarPythonParser.AT - 68)))) !== 0));
	            this.state = 719;
	            this.match(grammarPythonParser.DEDENT);
	            break;
	        default:
	            throw new antlr4.error.NoViableAltException(this);
	        }
	...
	test() {
	    ...
	    this.enterRule(localctx, 98, grammarPythonParser.RULE_test);
	    var _la = 0; // Token type
	    try {
	        this.state = 732;
	        this._errHandler.sync(this);
	...
	test_nocond() {
	    ...
	    this.enterRule(localctx, 100, grammarPythonParser.RULE_test_nocond);
	    try {
	        this.state = 736;
	        this._errHandler.sync(this);
	        switch(this._input.LA(1)) {
	...
	lambdef() {
	    ...
	    this.enterRule(localctx, 102, grammarPythonParser.RULE_lambdef);
	    var _la = 0; // Token type
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 738;
	        this.match(grammarPythonParser.LAMBDA);
	        this.state = 740;
	        this._errHandler.sync(this);
	        _la = this._input.LA(1);
	        if(((((_la - 42)) & ~0x1f) == 0 && ((1 << (_la - 42)) & ((1 << (grammarPythonParser.NAME - 42)) | (1 << (grammarPythonParser.STAR - 42)) | (1 << (grammarPythonParser.POWER - 42)))) !== 0)) {
	...
	lambdef_nocond() {
	    ...
	    this.enterRule(localctx, 104, grammarPythonParser.RULE_lambdef_nocond);
	    var _la = 0; // Token type
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 745;
	...
	or_test() {
	    ...
	    this.enterRule(localctx, 106, grammarPythonParser.RULE_or_test);
	    var _la = 0; // Token type
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 752;
	        ...
	        this._errHandler.sync(this);
	        _la = this._input.LA(1);
	        while(_la===grammarPythonParser.OR) {
	            this.state = 753;
	            this.match(grammarPythonParser.OR);
	            this.state = 754;
	            this.and_test();
	            this.state = 759;
	            this._errHandler.sync(this);
	...
	and_test() {
	    ...
	    this.enterRule(localctx, 108, grammarPythonParser.RULE_and_test);
	    var _la = 0; // Token type
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 760;
	        ...
	        this._errHandler.sync(this);
	        _la = this._input.LA(1);
	        while(_la===grammarPythonParser.AND) {
	            this.state = 761;
	            this.match(grammarPythonParser.AND);
	            this.state = 762;
	            this.not_test();
	            this.state = 767;
	            this._errHandler.sync(this);
	...
	not_test() {
	    ...
	    this.enterRule(localctx, 110, grammarPythonParser.RULE_not_test);
	    try {
	        this.state = 771;
	        this._errHandler.sync(this);
	        switch(this._input.LA(1)) {
	        case grammarPythonParser.NOT:
	            this.enterOuterAlt(localctx, 1);
	            this.state = 768;
	            this.match(grammarPythonParser.NOT);
	            this.state = 769;
	            this.not_test();
	            break;
	        case grammarPythonParser.STRING:
	...
	comparison() {
	    ...
	    this.enterRule(localctx, 112, grammarPythonParser.RULE_comparison);
	    var _la = 0; // Token type
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 773;
	        ...
	        this._errHandler.sync(this);
	        _la = this._input.LA(1);
	        while((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << grammarPythonParser.IN) | (1 << grammarPythonParser.NOT) | (1 << grammarPythonParser.IS))) !== 0) || ((((_la - 76)) & ~0x1f) == 0 && ((1 << (_la - 76)) & ((1 << (grammarPythonParser.LESS_THAN - 76)) | (1 << (grammarPythonParser.GREATER_THAN - 76)) | (1 << (grammarPythonParser.EQUALS - 76)) | (1 << (grammarPythonParser.GT_EQ - 76)) | (1 << (grammarPythonParser.LT_EQ - 76)) | (1 << (grammarPythonParser.NOT_EQ_1 - 76)) | (1 << (grammarPythonParser.NOT_EQ_2 - 76)))) !== 0)) {
	            this.state = 774;
	            this.comp_op();
	            this.state = 775;
	            this.expr();
	...
	comp_op() {
	    ...
	    this.enterRule(localctx, 114, grammarPythonParser.RULE_comp_op);
	    try {
	        this.state = 795;
	        this._errHandler.sync(this);
	        ...
	        case 1:
	            this.enterOuterAlt(localctx, 1);
	            this.state = 782;
	            this.match(grammarPythonParser.LESS_THAN);
	            break;

	        case 2:
	            this.enterOuterAlt(localctx, 2);
	            this.state = 783;
	            this.match(grammarPythonParser.GREATER_THAN);
	            break;

	        case 3:
	            this.enterOuterAlt(localctx, 3);
	            this.state = 784;
	            this.match(grammarPythonParser.EQUALS);
	            break;

	        case 4:
	            this.enterOuterAlt(localctx, 4);
	            this.state = 785;
	            this.match(grammarPythonParser.GT_EQ);
	            break;

	        case 5:
	            this.enterOuterAlt(localctx, 5);
	            this.state = 786;
	            this.match(grammarPythonParser.LT_EQ);
	            break;

	        case 6:
	            this.enterOuterAlt(localctx, 6);
	            this.state = 787;
	            this.match(grammarPythonParser.NOT_EQ_1);
	            break;

	        case 7:
	            this.enterOuterAlt(localctx, 7);
	            this.state = 788;
	            this.match(grammarPythonParser.NOT_EQ_2);
	            break;
	        ...
	        case 10:
	            ...
	            this.state = 792;
	            this.match(grammarPythonParser.IS);
	            break;
	...
	star_expr() {
	    ...
	    this.enterRule(localctx, 116, grammarPythonParser.RULE_star_expr);
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 797;
	        this.match(grammarPythonParser.STAR);
	...
	expr() {
	    ...
	    this.enterRule(localctx, 118, grammarPythonParser.RULE_expr);
	    var _la = 0; // Token type
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 800;
	        ...
	        this._errHandler.sync(this);
	        _la = this._input.LA(1);
	        while(_la===grammarPythonParser.OR_OP) {
	            this.state = 801;
	            this.match(grammarPythonParser.OR_OP);
	            this.state = 802;
	            this.xor_expr();
	            this.state = 807;
	            this._errHandler.sync(this);
	...
	xor_expr() {
	    ...
	    this.enterRule(localctx, 120, grammarPythonParser.RULE_xor_expr);
	    var _la = 0; // Token type
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 808;
	        ...
	        this._errHandler.sync(this);
	        _la = this._input.LA(1);
	        while(_la===grammarPythonParser.XOR) {
	            this.state = 809;
	            this.match(grammarPythonParser.XOR);
	            this.state = 810;
	            this.and_expr();
	            this.state = 815;
	            this._errHandler.sync(this);
	...
	and_expr() {
	    ...
	    this.enterRule(localctx, 122, grammarPythonParser.RULE_and_expr);
	    var _la = 0; // Token type
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 816;
	        ...
	        this._errHandler.sync(this);
	        _la = this._input.LA(1);
	        while(_la===grammarPythonParser.AND_OP) {
	            this.state = 817;
	            this.match(grammarPythonParser.AND_OP);
	            this.state = 818;
	            this.shift_expr();
	            this.state = 823;
	            this._errHandler.sync(this);
	...
	shift_expr() {
	    ...
	    this.enterRule(localctx, 124, grammarPythonParser.RULE_shift_expr);
	    var _la = 0; // Token type
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 824;
	        ...
	        this._errHandler.sync(this);
	        _la = this._input.LA(1);
	        while(_la===grammarPythonParser.LEFT_SHIFT || _la===grammarPythonParser.RIGHT_SHIFT) {
	            this.state = 825;
	            _la = this._input.LA(1);
	            if(!(_la===grammarPythonParser.LEFT_SHIFT || _la===grammarPythonParser.RIGHT_SHIFT)) {
	            this._errHandler.recoverInline(this);
	            }
	            else {
	            	this._errHandler.reportMatch(this);
	...
	arith_expr() {
	    ...
	    this.enterRule(localctx, 126, grammarPythonParser.RULE_arith_expr);
	    var _la = 0; // Token type
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 832;
	        ...
	        this._errHandler.sync(this);
	        _la = this._input.LA(1);
	        while(_la===grammarPythonParser.ADD || _la===grammarPythonParser.MINUS) {
	            this.state = 833;
	            _la = this._input.LA(1);
	            if(!(_la===grammarPythonParser.ADD || _la===grammarPythonParser.MINUS)) {
	            this._errHandler.recoverInline(this);
	            }
	            else {
	            	this._errHandler.reportMatch(this);
	...
	term() {
	    ...
	    this.enterRule(localctx, 128, grammarPythonParser.RULE_term);
	    var _la = 0; // Token type
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 840;
	        ...
	        this._errHandler.sync(this);
	        _la = this._input.LA(1);
	        while(((((_la - 53)) & ~0x1f) == 0 && ((1 << (_la - 53)) & ((1 << (grammarPythonParser.STAR - 53)) | (1 << (grammarPythonParser.DIV - 53)) | (1 << (grammarPythonParser.MOD - 53)) | (1 << (grammarPythonParser.IDIV - 53)) | (1 << (grammarPythonParser.AT - 53)))) !== 0)) {
	            this.state = 841;
	            _la = this._input.LA(1);
	            if(!(((((_la - 53)) & ~0x1f) == 0 && ((1 << (_la - 53)) & ((1 << (grammarPythonParser.STAR - 53)) | (1 << (grammarPythonParser.DIV - 53)) | (1 << (grammarPythonParser.MOD - 53)) | (1 << (grammarPythonParser.IDIV - 53)) | (1 << (grammarPythonParser.AT - 53)))) !== 0))) {
	            this._errHandler.recoverInline(this);
	            }
	            else {
	            	this._errHandler.reportMatch(this);
	...
	factor() {
	    ...
	    this.enterRule(localctx, 130, grammarPythonParser.RULE_factor);
	    var _la = 0; // Token type
	    try {
	        this.state = 851;
	        this._errHandler.sync(this);
	        ...
	        case grammarPythonParser.NOT_OP:
	            ...
	            this.state = 848;
	            _la = this._input.LA(1);
	            if(!(((((_la - 68)) & ~0x1f) == 0 && ((1 << (_la - 68)) & ((1 << (grammarPythonParser.ADD - 68)) | (1 << (grammarPythonParser.MINUS - 68)) | (1 << (grammarPythonParser.NOT_OP - 68)))) !== 0))) {
	            this._errHandler.recoverInline(this);
	            }
	            else {
	            	this._errHandler.reportMatch(this);
	...
	power() {
	    ...
	    this.enterRule(localctx, 132, grammarPythonParser.RULE_power);
	    var _la = 0; // Token type
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 853;
	...
	atom_expr() {
	    ...
	    this.enterRule(localctx, 134, grammarPythonParser.RULE_atom_expr);
	    var _la = 0; // Token type
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 859;
	        this._errHandler.sync(this);
	        _la = this._input.LA(1);
	        if(_la===grammarPythonParser.AWAIT) {
	            this.state = 858;
	            this.match(grammarPythonParser.AWAIT);
	        }
	        ...
	        this._errHandler.sync(this);
	        _la = this._input.LA(1);
	        while(((((_la - 51)) & ~0x1f) == 0 && ((1 << (_la - 51)) & ((1 << (grammarPythonParser.DOT - 51)) | (1 << (grammarPythonParser.OPEN_PAREN - 51)) | (1 << (grammarPythonParser.OPEN_BRACK - 51)))) !== 0)) {
	            this.state = 862;
	            this.trailer();
	            this.state = 867;
	            this._errHandler.sync(this);
	...
	atom() {
	    ...
	    this.enterRule(localctx, 136, grammarPythonParser.RULE_atom);
	    var _la = 0; // Token type
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 895;
	        ...
	        case grammarPythonParser.OPEN_BRACK:
	            this.state = 874;
	            this.match(grammarPythonParser.OPEN_BRACK);
	            this.state = 876;
	            this._errHandler.sync(this);
	            _la = this._input.LA(1);
	            if((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << grammarPythonParser.STRING) | (1 << grammarPythonParser.NUMBER) | (1 << grammarPythonParser.LAMBDA) | (1 << grammarPythonParser.NOT) | (1 << grammarPythonParser.NONE) | (1 << grammarPythonParser.TRUE))) !== 0) || ((((_la - 32)) & ~0x1f) == 0 && ((1 << (_la - 32)) & ((1 << (grammarPythonParser.FALSE - 32)) | (1 << (grammarPythonParser.AWAIT - 32)) | (1 << (grammarPythonParser.NAME - 32)) | (1 << (grammarPythonParser.ELLIPSIS - 32)) | (1 << (grammarPythonParser.STAR - 32)) | (1 << (grammarPythonParser.OPEN_PAREN - 32)) | (1 << (grammarPythonParser.OPEN_BRACK - 32)))) !== 0) || ((((_la - 68)) & ~0x1f) == 0 && ((1 << (_la - 68)) & ((1 << (grammarPythonParser.ADD - 68)) | (1 << (grammarPythonParser.MINUS - 68)) | (1 << (grammarPythonParser.NOT_OP - 68)) | (1 << (grammarPythonParser.OPEN_BRACE - 68)))) !== 0)) {
	            ...
	            this.state = 878;
	            this.match(grammarPythonParser.CLOSE_BRACK);
	            break;
	        case grammarPythonParser.OPEN_BRACE:
	            this.state = 879;
	            this.match(grammarPythonParser.OPEN_BRACE);
	            this.state = 881;
	            this._errHandler.sync(this);
	            _la = this._input.LA(1);
	            if((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << grammarPythonParser.STRING) | (1 << grammarPythonParser.NUMBER) | (1 << grammarPythonParser.LAMBDA) | (1 << grammarPythonParser.NOT) | (1 << grammarPythonParser.NONE) | (1 << grammarPythonParser.TRUE))) !== 0) || ((((_la - 32)) & ~0x1f) == 0 && ((1 << (_la - 32)) & ((1 << (grammarPythonParser.FALSE - 32)) | (1 << (grammarPythonParser.AWAIT - 32)) | (1 << (grammarPythonParser.NAME - 32)) | (1 << (grammarPythonParser.ELLIPSIS - 32)) | (1 << (grammarPythonParser.STAR - 32)) | (1 << (grammarPythonParser.OPEN_PAREN - 32)) | (1 << (grammarPythonParser.POWER - 32)) | (1 << (grammarPythonParser.OPEN_BRACK - 32)))) !== 0) || ((((_la - 68)) & ~0x1f) == 0 && ((1 << (_la - 68)) & ((1 << (grammarPythonParser.ADD - 68)) | (1 << (grammarPythonParser.MINUS - 68)) | (1 << (grammarPythonParser.NOT_OP - 68)) | (1 << (grammarPythonParser.OPEN_BRACE - 68)))) !== 0)) {
	            ...
	            this.state = 883;
	            this.match(grammarPythonParser.CLOSE_BRACE);
	            break;
	        case grammarPythonParser.NAME:
	            this.state = 884;
	            this.match(grammarPythonParser.NAME);
	        ...
	        case grammarPythonParser.NUMBER:
	            this.state = 885;
	            this.match(grammarPythonParser.NUMBER);
	            break;
	        case grammarPythonParser.STRING:
	            this.state = 887; 
	            this._errHandler.sync(this);
	            ...
	            do {
	                this.state = 886;
	                this.match(grammarPythonParser.STRING);
	                this.state = 889; 
	                this._errHandler.sync(this);
	                _la = this._input.LA(1);
	            } while(_la===grammarPythonParser.STRING);
	            break;
	        case grammarPythonParser.ELLIPSIS:
	            this.state = 891;
	            this.match(grammarPythonParser.ELLIPSIS);
	            break;
	        case grammarPythonParser.NONE:
	            this.state = 892;
	            this.match(grammarPythonParser.NONE);
	            break;
	        case grammarPythonParser.TRUE:
	            this.state = 893;
	            this.match(grammarPythonParser.TRUE);
	            break;
	        case grammarPythonParser.FALSE:
	            this.state = 894;
	            this.match(grammarPythonParser.FALSE);
	            break;
	        default:
	            throw new antlr4.error.NoViableAltException(this);
	        }
	...
	testlist_comp() {
	    ...
	    this.enterRule(localctx, 138, grammarPythonParser.RULE_testlist_comp);
	    var _la = 0; // Token type
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 899;
	        ...
	        case grammarPythonParser.ASYNC:
	            ...
	            break;
	        case grammarPythonParser.CLOSE_PAREN:
	        case grammarPythonParser.COMMA:
	        case grammarPythonParser.CLOSE_BRACK:
	            this.state = 909;
	            this._errHandler.sync(this);
	...
	trailer() {
	    ...
	    this.enterRule(localctx, 140, grammarPythonParser.RULE_trailer);
	    var _la = 0; // Token type
	    try {
	        this.state = 928;
	        this._errHandler.sync(this);
	...
	subscriptlist() {
	    ...
	    this.enterRule(localctx, 142, grammarPythonParser.RULE_subscriptlist);
	    var _la = 0; // Token type
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 930;
	...
	subscript_() {
	    ...
	    this.enterRule(localctx, 144, grammarPythonParser.RULE_subscript_);
	    var _la = 0; // Token type
	    try {
	        this.state = 952;
	        this._errHandler.sync(this);
	...
	sliceop() {
	    ...
	    this.enterRule(localctx, 146, grammarPythonParser.RULE_sliceop);
	    var _la = 0; // Token type
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 954;
	...
	exprlist() {
	    ...
	    this.enterRule(localctx, 148, grammarPythonParser.RULE_exprlist);
	    var _la = 0; // Token type
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 960;
	...
	testlist() {
	    ...
	    this.enterRule(localctx, 150, grammarPythonParser.RULE_testlist);
	    var _la = 0; // Token type
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 975;
	...
	dictorsetmaker() {
	    ...
	    this.enterRule(localctx, 152, grammarPythonParser.RULE_dictorsetmaker);
	    var _la = 0; // Token type
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 1034;
	        ...
	        case 1:
	            ...
	            case grammarPythonParser.ASYNC:
	                ...
	                break;
	            case grammarPythonParser.COMMA:
	            case grammarPythonParser.CLOSE_BRACE:
	                this.state = 1006;
	                this._errHandler.sync(this);
	...
	classdef() {
	    ...
	    this.enterRule(localctx, 154, grammarPythonParser.RULE_classdef);
	    var _la = 0; // Token type
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 1036;
	        this.match(grammarPythonParser.CLASS);
	        this.state = 1037;
	        this.match(grammarPythonParser.NAME);
	        this.state = 1043;
	        this._errHandler.sync(this);
	...
	arglist() {
	    ...
	    this.enterRule(localctx, 156, grammarPythonParser.RULE_arglist);
	    var _la = 0; // Token type
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 1048;
	...
	argument() {
	    ...
	    this.enterRule(localctx, 158, grammarPythonParser.RULE_argument);
	    var _la = 0; // Token type
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 1071;
	        ...
	        case 1:
	            ...
	            this._errHandler.sync(this);
	            _la = this._input.LA(1);
	            if(_la===grammarPythonParser.FOR || _la===grammarPythonParser.ASYNC) {
	                this.state = 1060;
	                this.comp_for();
	            }
	...
	comp_iter() {
	    ...
	    this.enterRule(localctx, 160, grammarPythonParser.RULE_comp_iter);
	    try {
	        this.state = 1075;
	        this._errHandler.sync(this);
	        switch(this._input.LA(1)) {
	...
	comp_for() {
	    ...
	    this.enterRule(localctx, 162, grammarPythonParser.RULE_comp_for);
	    var _la = 0; // Token type
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 1078;
	        this._errHandler.sync(this);
	        _la = this._input.LA(1);
	        if(_la===grammarPythonParser.ASYNC) {
	            this.state = 1077;
	            this.match(grammarPythonParser.ASYNC);
	        }
	        ...
	        this._errHandler.sync(this);
	        _la = this._input.LA(1);
	        if(((((_la - 15)) & ~0x1f) == 0 && ((1 << (_la - 15)) & ((1 << (grammarPythonParser.IF - 15)) | (1 << (grammarPythonParser.FOR - 15)) | (1 << (grammarPythonParser.ASYNC - 15)))) !== 0)) {
	            this.state = 1084;
	            this.comp_iter();
	        }
	...
	comp_if() {
	    ...
	    this.enterRule(localctx, 164, grammarPythonParser.RULE_comp_if);
	    var _la = 0; // Token type
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 1087;
	...
	encoding_decl() {
	    ...
	    this.enterRule(localctx, 166, grammarPythonParser.RULE_encoding_decl);
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 1092;
	        this.match(grammarPythonParser.NAME);
	...
	yield_expr() {
	    ...
	    this.enterRule(localctx, 168, grammarPythonParser.RULE_yield_expr);
	    var _la = 0; // Token type
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 1094;
	        this.match(grammarPythonParser.YIELD);
	        this.state = 1096;
	        this._errHandler.sync(this);
	        _la = this._input.LA(1);
	        if((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << grammarPythonParser.STRING) | (1 << grammarPythonParser.NUMBER) | (1 << grammarPythonParser.FROM) | (1 << grammarPythonParser.LAMBDA) | (1 << grammarPythonParser.NOT) | (1 << grammarPythonParser.NONE) | (1 << grammarPythonParser.TRUE))) !== 0) || ((((_la - 32)) & ~0x1f) == 0 && ((1 << (_la - 32)) & ((1 << (grammarPythonParser.FALSE - 32)) | (1 << (grammarPythonParser.AWAIT - 32)) | (1 << (grammarPythonParser.NAME - 32)) | (1 << (grammarPythonParser.ELLIPSIS - 32)) | (1 << (grammarPythonParser.OPEN_PAREN - 32)) | (1 << (grammarPythonParser.OPEN_BRACK - 32)))) !== 0) || ((((_la - 68)) & ~0x1f) == 0 && ((1 << (_la - 68)) & ((1 << (grammarPythonParser.ADD - 68)) | (1 << (grammarPythonParser.MINUS - 68)) | (1 << (grammarPythonParser.NOT_OP - 68)) | (1 << (grammarPythonParser.OPEN_BRACE - 68)))) !== 0)) {
	            this.state = 1095;
	            this.yield_arg();
	        }
	...
	yield_arg() {
	    ...
	    this.enterRule(localctx, 170, grammarPythonParser.RULE_yield_arg);
	    try {
	        this.state = 1101;
	        this._errHandler.sync(this);
	        switch(this._input.LA(1)) {
...
grammarPythonParser.INDENT = 1;
grammarPythonParser.DEDENT = 2;
grammarPythonParser.STRING = 3;
grammarPythonParser.NUMBER = 4;
grammarPythonParser.INTEGER = 5;
grammarPythonParser.DEF = 6;
grammarPythonParser.RETURN = 7;
grammarPythonParser.RAISE = 8;
grammarPythonParser.FROM = 9;
grammarPythonParser.IMPORT = 10;
grammarPythonParser.AS = 11;
grammarPythonParser.GLOBAL = 12;
grammarPythonParser.NONLOCAL = 13;
grammarPythonParser.ASSERT = 14;
grammarPythonParser.IF = 15;
grammarPythonParser.ELIF = 16;
grammarPythonParser.ELSE = 17;
grammarPythonParser.WHILE = 18;
grammarPythonParser.FOR = 19;
grammarPythonParser.IN = 20;
grammarPythonParser.TRY = 21;
grammarPythonParser.FINALLY = 22;
grammarPythonParser.WITH = 23;
grammarPythonParser.EXCEPT = 24;
grammarPythonParser.LAMBDA = 25;
grammarPythonParser.OR = 26;
grammarPythonParser.AND = 27;
grammarPythonParser.NOT = 28;
grammarPythonParser.IS = 29;
grammarPythonParser.NONE = 30;
grammarPythonParser.TRUE = 31;
grammarPythonParser.FALSE = 32;
grammarPythonParser.CLASS = 33;
grammarPythonParser.YIELD = 34;
grammarPythonParser.DEL = 35;
grammarPythonParser.PASS = 36;
grammarPythonParser.CONTINUE = 37;
grammarPythonParser.BREAK = 38;
grammarPythonParser.ASYNC = 39;
grammarPythonParser.AWAIT = 40;
grammarPythonParser.NEWLINE = 41;
grammarPythonParser.NAME = 42;
grammarPythonParser.STRING_LITERAL = 43;
grammarPythonParser.BYTES_LITERAL = 44;
grammarPythonParser.DECIMAL_INTEGER = 45;
grammarPythonParser.OCT_INTEGER = 46;
grammarPythonParser.HEX_INTEGER = 47;
grammarPythonParser.BIN_INTEGER = 48;
grammarPythonParser.FLOAT_NUMBER = 49;
grammarPythonParser.IMAG_NUMBER = 50;
grammarPythonParser.DOT = 51;
grammarPythonParser.ELLIPSIS = 52;
grammarPythonParser.STAR = 53;
grammarPythonParser.OPEN_PAREN = 54;
grammarPythonParser.CLOSE_PAREN = 55;
grammarPythonParser.COMMA = 56;
grammarPythonParser.COLON = 57;
grammarPythonParser.SEMI_COLON = 58;
grammarPythonParser.POWER = 59;
grammarPythonParser.ASSIGN = 60;
grammarPythonParser.OPEN_BRACK = 61;
grammarPythonParser.CLOSE_BRACK = 62;
grammarPythonParser.OR_OP = 63;
grammarPythonParser.XOR = 64;
grammarPythonParser.AND_OP = 65;
grammarPythonParser.LEFT_SHIFT = 66;
grammarPythonParser.RIGHT_SHIFT = 67;
grammarPythonParser.ADD = 68;
grammarPythonParser.MINUS = 69;
grammarPythonParser.DIV = 70;
grammarPythonParser.MOD = 71;
grammarPythonParser.IDIV = 72;
grammarPythonParser.NOT_OP = 73;
grammarPythonParser.OPEN_BRACE = 74;
grammarPythonParser.CLOSE_BRACE = 75;
grammarPythonParser.LESS_THAN = 76;
grammarPythonParser.GREATER_THAN = 77;
grammarPythonParser.EQUALS = 78;
grammarPythonParser.GT_EQ = 79;
grammarPythonParser.LT_EQ = 80;
grammarPythonParser.NOT_EQ_1 = 81;
grammarPythonParser.NOT_EQ_2 = 82;
grammarPythonParser.AT = 83;
grammarPythonParser.ARROW = 84;
grammarPythonParser.ADD_ASSIGN = 85;
grammarPythonParser.SUB_ASSIGN = 86;
grammarPythonParser.MULT_ASSIGN = 87;
grammarPythonParser.AT_ASSIGN = 88;
grammarPythonParser.DIV_ASSIGN = 89;
grammarPythonParser.MOD_ASSIGN = 90;
grammarPythonParser.AND_ASSIGN = 91;
grammarPythonParser.OR_ASSIGN = 92;
grammarPythonParser.XOR_ASSIGN = 93;
grammarPythonParser.LEFT_SHIFT_ASSIGN = 94;
grammarPythonParser.RIGHT_SHIFT_ASSIGN = 95;
grammarPythonParser.POWER_ASSIGN = 96;
grammarPythonParser.IDIV_ASSIGN = 97;
grammarPythonParser.SKIP_ = 98;
grammarPythonParser.UNKNOWN_CHAR = 99;

grammarPythonParser.RULE_single_input = 0;
grammarPythonParser.RULE_file_input = 1;
grammarPythonParser.RULE_eval_input = 2;
grammarPythonParser.RULE_decorator = 3;
grammarPythonParser.RULE_decorators = 4;
grammarPythonParser.RULE_decorated = 5;
grammarPythonParser.RULE_async_funcdef = 6;
grammarPythonParser.RULE_funcdef = 7;
grammarPythonParser.RULE_parameters = 8;
grammarPythonParser.RULE_typedargslist = 9;
grammarPythonParser.RULE_tfpdef = 10;
grammarPythonParser.RULE_varargslist = 11;
grammarPythonParser.RULE_vfpdef = 12;
grammarPythonParser.RULE_stmt = 13;
grammarPythonParser.RULE_simple_stmt = 14;
grammarPythonParser.RULE_small_stmt = 15;
grammarPythonParser.RULE_expr_stmt = 16;
grammarPythonParser.RULE_annassign = 17;
grammarPythonParser.RULE_testlist_star_expr = 18;
grammarPythonParser.RULE_augassign = 19;
grammarPythonParser.RULE_del_stmt = 20;
grammarPythonParser.RULE_pass_stmt = 21;
grammarPythonParser.RULE_flow_stmt = 22;
grammarPythonParser.RULE_break_stmt = 23;
grammarPythonParser.RULE_continue_stmt = 24;
grammarPythonParser.RULE_return_stmt = 25;
grammarPythonParser.RULE_yield_stmt = 26;
grammarPythonParser.RULE_raise_stmt = 27;
grammarPythonParser.RULE_import_stmt = 28;
grammarPythonParser.RULE_import_name = 29;
grammarPythonParser.RULE_import_from = 30;
grammarPythonParser.RULE_import_as_name = 31;
grammarPythonParser.RULE_dotted_as_name = 32;
grammarPythonParser.RULE_import_as_names = 33;
grammarPythonParser.RULE_dotted_as_names = 34;
grammarPythonParser.RULE_dotted_name = 35;
grammarPythonParser.RULE_global_stmt = 36;
grammarPythonParser.RULE_nonlocal_stmt = 37;
grammarPythonParser.RULE_assert_stmt = 38;
grammarPythonParser.RULE_compound_stmt = 39;
grammarPythonParser.RULE_async_stmt = 40;
grammarPythonParser.RULE_if_stmt = 41;
grammarPythonParser.RULE_while_stmt = 42;
grammarPythonParser.RULE_for_stmt = 43;
grammarPythonParser.RULE_try_stmt = 44;
grammarPythonParser.RULE_with_stmt = 45;
grammarPythonParser.RULE_with_item = 46;
grammarPythonParser.RULE_except_clause = 47;
grammarPythonParser.RULE_suite = 48;
grammarPythonParser.RULE_test = 49;
grammarPythonParser.RULE_test_nocond = 50;
grammarPythonParser.RULE_lambdef = 51;
grammarPythonParser.RULE_lambdef_nocond = 52;
grammarPythonParser.RULE_or_test = 53;
grammarPythonParser.RULE_and_test = 54;
grammarPythonParser.RULE_not_test = 55;
grammarPythonParser.RULE_comparison = 56;
grammarPythonParser.RULE_comp_op = 57;
grammarPythonParser.RULE_star_expr = 58;
grammarPythonParser.RULE_expr = 59;
grammarPythonParser.RULE_xor_expr = 60;
grammarPythonParser.RULE_and_expr = 61;
grammarPythonParser.RULE_shift_expr = 62;
grammarPythonParser.RULE_arith_expr = 63;
grammarPythonParser.RULE_term = 64;
grammarPythonParser.RULE_factor = 65;
grammarPythonParser.RULE_power = 66;
grammarPythonParser.RULE_atom_expr = 67;
grammarPythonParser.RULE_atom = 68;
grammarPythonParser.RULE_testlist_comp = 69;
grammarPythonParser.RULE_trailer = 70;
grammarPythonParser.RULE_subscriptlist = 71;
grammarPythonParser.RULE_subscript_ = 72;
grammarPythonParser.RULE_sliceop = 73;
grammarPythonParser.RULE_exprlist = 74;
grammarPythonParser.RULE_testlist = 75;
grammarPythonParser.RULE_dictorsetmaker = 76;
grammarPythonParser.RULE_classdef = 77;
grammarPythonParser.RULE_arglist = 78;
grammarPythonParser.RULE_argument = 79;
grammarPythonParser.RULE_comp_iter = 80;
grammarPythonParser.RULE_comp_for = 81;
grammarPythonParser.RULE_comp_if = 82;
grammarPythonParser.RULE_encoding_decl = 83;
grammarPythonParser.RULE_yield_expr = 84;
grammarPythonParser.RULE_yield_arg = 85;
...
class Single_inputContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        this.parser = parser;
        this.ruleIndex = grammarPythonParser.RULE_single_input;
    }

	NEWLINE() {
	    return this.getToken(grammarPythonParser.NEWLINE, 0);
	};
...
class File_inputContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = grammarPythonParser.RULE_file_input;
    }

	EOF() {
	    return this.getToken(grammarPythonParser.EOF, 0);
	};
	...
	NEWLINE = function(i) {
	    ...
	    if(i===null) {
	        return this.getTokens(grammarPythonParser.NEWLINE);
	    } else {
	        return this.getToken(grammarPythonParser.NEWLINE, i);
	    }
	};
...
class Eval_inputContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = grammarPythonParser.RULE_eval_input;
    }
...
class DecoratorContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = grammarPythonParser.RULE_decorator;
    }

	AT() {
	    return this.getToken(grammarPythonParser.AT, 0);
	};
	...
	OPEN_PAREN() {
	    return this.getToken(grammarPythonParser.OPEN_PAREN, 0);
	};

	CLOSE_PAREN() {
	    return this.getToken(grammarPythonParser.CLOSE_PAREN, 0);
	};
...
class DecoratorsContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = grammarPythonParser.RULE_decorators;
    }
...
class DecoratedContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = grammarPythonParser.RULE_decorated;
    }
...
class Async_funcdefContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = grammarPythonParser.RULE_async_funcdef;
    }

	ASYNC() {
	    return this.getToken(grammarPythonParser.ASYNC, 0);
	};
...
class FuncdefContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = grammarPythonParser.RULE_funcdef;
    }

	DEF() {
	    return this.getToken(grammarPythonParser.DEF, 0);
	};

	NAME() {
	    return this.getToken(grammarPythonParser.NAME, 0);
	};
	...
	COLON() {
	    return this.getToken(grammarPythonParser.COLON, 0);
	};
	...
	ARROW() {
	    return this.getToken(grammarPythonParser.ARROW, 0);
	};
...
class ParametersContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = grammarPythonParser.RULE_parameters;
    }
...
class TypedargslistContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = grammarPythonParser.RULE_typedargslist;
    }
	...
	STAR() {
	    return this.getToken(grammarPythonParser.STAR, 0);
	};

	POWER() {
	    return this.getToken(grammarPythonParser.POWER, 0);
	};
	...
	ASSIGN = function(i) {
	    ...
	    if(i===null) {
	        return this.getTokens(grammarPythonParser.ASSIGN);
	    } else {
	        return this.getToken(grammarPythonParser.ASSIGN, i);
	    }
	};
...
class TfpdefContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = grammarPythonParser.RULE_tfpdef;
    }
...
class VarargslistContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = grammarPythonParser.RULE_varargslist;
    }
...
class VfpdefContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = grammarPythonParser.RULE_vfpdef;
    }
...
class StmtContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = grammarPythonParser.RULE_stmt;
    }
...
class Simple_stmtContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = grammarPythonParser.RULE_simple_stmt;
    }
	...
	SEMI_COLON = function(i) {
	    ...
	    if(i===null) {
	        return this.getTokens(grammarPythonParser.SEMI_COLON);
	    } else {
	        return this.getToken(grammarPythonParser.SEMI_COLON, i);
	    }
	};
...
class Small_stmtContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = grammarPythonParser.RULE_small_stmt;
    }
...
class Expr_stmtContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = grammarPythonParser.RULE_expr_stmt;
    }
...
class AnnassignContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = grammarPythonParser.RULE_annassign;
    }
	...
	ASSIGN() {
	    return this.getToken(grammarPythonParser.ASSIGN, 0);
	};
...
class Testlist_star_exprContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = grammarPythonParser.RULE_testlist_star_expr;
    }
...
class AugassignContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = grammarPythonParser.RULE_augassign;
    }

	ADD_ASSIGN() {
	    return this.getToken(grammarPythonParser.ADD_ASSIGN, 0);
	};

	SUB_ASSIGN() {
	    return this.getToken(grammarPythonParser.SUB_ASSIGN, 0);
	};

	MULT_ASSIGN() {
	    return this.getToken(grammarPythonParser.MULT_ASSIGN, 0);
	};

	AT_ASSIGN() {
	    return this.getToken(grammarPythonParser.AT_ASSIGN, 0);
	};

	DIV_ASSIGN() {
	    return this.getToken(grammarPythonParser.DIV_ASSIGN, 0);
	};

	MOD_ASSIGN() {
	    return this.getToken(grammarPythonParser.MOD_ASSIGN, 0);
	};

	AND_ASSIGN() {
	    return this.getToken(grammarPythonParser.AND_ASSIGN, 0);
	};

	OR_ASSIGN() {
	    return this.getToken(grammarPythonParser.OR_ASSIGN, 0);
	};

	XOR_ASSIGN() {
	    return this.getToken(grammarPythonParser.XOR_ASSIGN, 0);
	};

	LEFT_SHIFT_ASSIGN() {
	    return this.getToken(grammarPythonParser.LEFT_SHIFT_ASSIGN, 0);
	};

	RIGHT_SHIFT_ASSIGN() {
	    return this.getToken(grammarPythonParser.RIGHT_SHIFT_ASSIGN, 0);
	};

	POWER_ASSIGN() {
	    return this.getToken(grammarPythonParser.POWER_ASSIGN, 0);
	};

	IDIV_ASSIGN() {
	    return this.getToken(grammarPythonParser.IDIV_ASSIGN, 0);
	};
...
class Del_stmtContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = grammarPythonParser.RULE_del_stmt;
    }

	DEL() {
	    return this.getToken(grammarPythonParser.DEL, 0);
	};
...
class Pass_stmtContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = grammarPythonParser.RULE_pass_stmt;
    }

	PASS() {
	    return this.getToken(grammarPythonParser.PASS, 0);
	};
...
class Flow_stmtContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = grammarPythonParser.RULE_flow_stmt;
    }
...
class Break_stmtContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = grammarPythonParser.RULE_break_stmt;
    }

	BREAK() {
	    return this.getToken(grammarPythonParser.BREAK, 0);
	};
...
class Continue_stmtContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = grammarPythonParser.RULE_continue_stmt;
    }

	CONTINUE() {
	    return this.getToken(grammarPythonParser.CONTINUE, 0);
	};
...
class Return_stmtContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = grammarPythonParser.RULE_return_stmt;
    }

	RETURN() {
	    return this.getToken(grammarPythonParser.RETURN, 0);
	};
...
class Yield_stmtContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = grammarPythonParser.RULE_yield_stmt;
    }
...
class Raise_stmtContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = grammarPythonParser.RULE_raise_stmt;
    }

	RAISE() {
	    return this.getToken(grammarPythonParser.RAISE, 0);
	};
	...
	FROM() {
	    return this.getToken(grammarPythonParser.FROM, 0);
	};
...
class Import_stmtContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = grammarPythonParser.RULE_import_stmt;
    }
...
class Import_nameContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = grammarPythonParser.RULE_import_name;
    }

	IMPORT() {
	    return this.getToken(grammarPythonParser.IMPORT, 0);
	};
...
class Import_fromContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = grammarPythonParser.RULE_import_from;
    }
	...
	DOT = function(i) {
	    ...
	    if(i===null) {
	        return this.getTokens(grammarPythonParser.DOT);
	    } else {
	        return this.getToken(grammarPythonParser.DOT, i);
	    }
	};
	...
	ELLIPSIS = function(i) {
	    ...
	    if(i===null) {
	        return this.getTokens(grammarPythonParser.ELLIPSIS);
	    } else {
	        return this.getToken(grammarPythonParser.ELLIPSIS, i);
	    }
	};
...
class Import_as_nameContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = grammarPythonParser.RULE_import_as_name;
    }
	...
	NAME = function(i) {
	    ...
	    if(i===null) {
	        return this.getTokens(grammarPythonParser.NAME);
	    } else {
	        return this.getToken(grammarPythonParser.NAME, i);
	    }
	};


	AS() {
	    return this.getToken(grammarPythonParser.AS, 0);
	};
...
class Dotted_as_nameContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = grammarPythonParser.RULE_dotted_as_name;
    }
...
class Import_as_namesContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = grammarPythonParser.RULE_import_as_names;
    }
...
class Dotted_as_namesContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = grammarPythonParser.RULE_dotted_as_names;
    }
...
class Dotted_nameContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = grammarPythonParser.RULE_dotted_name;
    }
...
class Global_stmtContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = grammarPythonParser.RULE_global_stmt;
    }

	GLOBAL() {
	    return this.getToken(grammarPythonParser.GLOBAL, 0);
	};
...
class Nonlocal_stmtContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = grammarPythonParser.RULE_nonlocal_stmt;
    }

	NONLOCAL() {
	    return this.getToken(grammarPythonParser.NONLOCAL, 0);
	};
...
class Assert_stmtContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = grammarPythonParser.RULE_assert_stmt;
    }

	ASSERT() {
	    return this.getToken(grammarPythonParser.ASSERT, 0);
	};
	...
	COMMA() {
	    return this.getToken(grammarPythonParser.COMMA, 0);
	};
...
class Compound_stmtContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = grammarPythonParser.RULE_compound_stmt;
    }
...
class Async_stmtContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = grammarPythonParser.RULE_async_stmt;
    }
...
class If_stmtContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = grammarPythonParser.RULE_if_stmt;
    }

	IF() {
	    return this.getToken(grammarPythonParser.IF, 0);
	};
	...
	COLON = function(i) {
	    ...
	    if(i===null) {
	        return this.getTokens(grammarPythonParser.COLON);
	    } else {
	        return this.getToken(grammarPythonParser.COLON, i);
	    }
	};
	...
	ELIF = function(i) {
	    ...
	    if(i===null) {
	        return this.getTokens(grammarPythonParser.ELIF);
	    } else {
	        return this.getToken(grammarPythonParser.ELIF, i);
	    }
	};


	ELSE() {
	    return this.getToken(grammarPythonParser.ELSE, 0);
	};
...
class While_stmtContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = grammarPythonParser.RULE_while_stmt;
    }

	WHILE() {
	    return this.getToken(grammarPythonParser.WHILE, 0);
	};
...
class For_stmtContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = grammarPythonParser.RULE_for_stmt;
    }

	FOR() {
	    return this.getToken(grammarPythonParser.FOR, 0);
	};
	...
	IN() {
	    return this.getToken(grammarPythonParser.IN, 0);
	};
...
class Try_stmtContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = grammarPythonParser.RULE_try_stmt;
    }

	TRY() {
	    return this.getToken(grammarPythonParser.TRY, 0);
	};
	...
	FINALLY() {
	    return this.getToken(grammarPythonParser.FINALLY, 0);
	};
...
class With_stmtContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = grammarPythonParser.RULE_with_stmt;
    }

	WITH() {
	    return this.getToken(grammarPythonParser.WITH, 0);
	};
...
class With_itemContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = grammarPythonParser.RULE_with_item;
    }
...
class Except_clauseContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = grammarPythonParser.RULE_except_clause;
    }

	EXCEPT() {
	    return this.getToken(grammarPythonParser.EXCEPT, 0);
	};
...
class SuiteContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = grammarPythonParser.RULE_suite;
    }
	...
	INDENT() {
	    return this.getToken(grammarPythonParser.INDENT, 0);
	};

	DEDENT() {
	    return this.getToken(grammarPythonParser.DEDENT, 0);
	};
...
class TestContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = grammarPythonParser.RULE_test;
    }
...
class Test_nocondContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = grammarPythonParser.RULE_test_nocond;
    }
...
class LambdefContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = grammarPythonParser.RULE_lambdef;
    }

	LAMBDA() {
	    return this.getToken(grammarPythonParser.LAMBDA, 0);
	};
...
class Lambdef_nocondContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = grammarPythonParser.RULE_lambdef_nocond;
    }
...
class Or_testContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = grammarPythonParser.RULE_or_test;
    }
	...
	OR = function(i) {
	    ...
	    if(i===null) {
	        return this.getTokens(grammarPythonParser.OR);
	    } else {
	        return this.getToken(grammarPythonParser.OR, i);
	    }
	};
...
class And_testContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = grammarPythonParser.RULE_and_test;
    }
	...
	AND = function(i) {
	    ...
	    if(i===null) {
	        return this.getTokens(grammarPythonParser.AND);
	    } else {
	        return this.getToken(grammarPythonParser.AND, i);
	    }
	};
...
class Not_testContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = grammarPythonParser.RULE_not_test;
    }

	NOT() {
	    return this.getToken(grammarPythonParser.NOT, 0);
	};
...
class ComparisonContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = grammarPythonParser.RULE_comparison;
    }
...
class Comp_opContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = grammarPythonParser.RULE_comp_op;
    }

	LESS_THAN() {
	    return this.getToken(grammarPythonParser.LESS_THAN, 0);
	};

	GREATER_THAN() {
	    return this.getToken(grammarPythonParser.GREATER_THAN, 0);
	};

	EQUALS() {
	    return this.getToken(grammarPythonParser.EQUALS, 0);
	};

	GT_EQ() {
	    return this.getToken(grammarPythonParser.GT_EQ, 0);
	};

	LT_EQ() {
	    return this.getToken(grammarPythonParser.LT_EQ, 0);
	};

	NOT_EQ_1() {
	    return this.getToken(grammarPythonParser.NOT_EQ_1, 0);
	};

	NOT_EQ_2() {
	    return this.getToken(grammarPythonParser.NOT_EQ_2, 0);
	};
	...
	IS() {
	    return this.getToken(grammarPythonParser.IS, 0);
	};
...
class Star_exprContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = grammarPythonParser.RULE_star_expr;
    }
...
class ExprContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = grammarPythonParser.RULE_expr;
    }
	...
	OR_OP = function(i) {
	    ...
	    if(i===null) {
	        return this.getTokens(grammarPythonParser.OR_OP);
	    } else {
	        return this.getToken(grammarPythonParser.OR_OP, i);
	    }
	};
...
class Xor_exprContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = grammarPythonParser.RULE_xor_expr;
    }
	...
	XOR = function(i) {
	    ...
	    if(i===null) {
	        return this.getTokens(grammarPythonParser.XOR);
	    } else {
	        return this.getToken(grammarPythonParser.XOR, i);
	    }
	};
...
class And_exprContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = grammarPythonParser.RULE_and_expr;
    }
	...
	AND_OP = function(i) {
	    ...
	    if(i===null) {
	        return this.getTokens(grammarPythonParser.AND_OP);
	    } else {
	        return this.getToken(grammarPythonParser.AND_OP, i);
	    }
	};
...
class Shift_exprContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = grammarPythonParser.RULE_shift_expr;
    }
	...
	LEFT_SHIFT = function(i) {
	    ...
	    if(i===null) {
	        return this.getTokens(grammarPythonParser.LEFT_SHIFT);
	    } else {
	        return this.getToken(grammarPythonParser.LEFT_SHIFT, i);
	    }
	};
	...
	RIGHT_SHIFT = function(i) {
	    ...
	    if(i===null) {
	        return this.getTokens(grammarPythonParser.RIGHT_SHIFT);
	    } else {
	        return this.getToken(grammarPythonParser.RIGHT_SHIFT, i);
	    }
	};
...
class Arith_exprContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = grammarPythonParser.RULE_arith_expr;
    }
	...
	ADD = function(i) {
	    ...
	    if(i===null) {
	        return this.getTokens(grammarPythonParser.ADD);
	    } else {
	        return this.getToken(grammarPythonParser.ADD, i);
	    }
	};
...
class TermContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = grammarPythonParser.RULE_term;
    }
	...
	STAR = function(i) {
	    ...
	    if(i===null) {
	        return this.getTokens(grammarPythonParser.STAR);
	    } else {
	        return this.getToken(grammarPythonParser.STAR, i);
	    }
	};
	...
	AT = function(i) {
	    ...
	    if(i===null) {
	        return this.getTokens(grammarPythonParser.AT);
	    } else {
	        return this.getToken(grammarPythonParser.AT, i);
	    }
	};
	...
	MOD = function(i) {
	    ...
	    if(i===null) {
	        return this.getTokens(grammarPythonParser.MOD);
	    } else {
	        return this.getToken(grammarPythonParser.MOD, i);
	    }
	};
	...
	IDIV = function(i) {
	    ...
	    if(i===null) {
	        return this.getTokens(grammarPythonParser.IDIV);
	    } else {
	        return this.getToken(grammarPythonParser.IDIV, i);
	    }
	};
...
class FactorContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = grammarPythonParser.RULE_factor;
    }
	...
	ADD() {
	    return this.getToken(grammarPythonParser.ADD, 0);
	};
	...
	NOT_OP() {
	    return this.getToken(grammarPythonParser.NOT_OP, 0);
	};
...
class PowerContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = grammarPythonParser.RULE_power;
    }
...
class Atom_exprContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = grammarPythonParser.RULE_atom_expr;
    }
	...
	AWAIT() {
	    return this.getToken(grammarPythonParser.AWAIT, 0);
	};
...
class AtomContext extends antlr4.ParserRuleContext {
	...
	OPEN_BRACK() {
	    return this.getToken(grammarPythonParser.OPEN_BRACK, 0);
	};

	CLOSE_BRACK() {
	    return this.getToken(grammarPythonParser.CLOSE_BRACK, 0);
	};

	OPEN_BRACE() {
	    return this.getToken(grammarPythonParser.OPEN_BRACE, 0);
	};

	CLOSE_BRACE() {
	    return this.getToken(grammarPythonParser.CLOSE_BRACE, 0);
	};
	...
	NUMBER() {
	    return this.getToken(grammarPythonParser.NUMBER, 0);
	};

	ELLIPSIS() {
	    return this.getToken(grammarPythonParser.ELLIPSIS, 0);
	};

	NONE() {
	    return this.getToken(grammarPythonParser.NONE, 0);
	};

	TRUE() {
	    return this.getToken(grammarPythonParser.TRUE, 0);
	};

	FALSE() {
	    return this.getToken(grammarPythonParser.FALSE, 0);
	};
	...
	STRING = function(i) {
	    ...
	    if(i===null) {
	        return this.getTokens(grammarPythonParser.STRING);
	    } else {
	        return this.getToken(grammarPythonParser.STRING, i);
	    }
	};
...
class Testlist_compContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = grammarPythonParser.RULE_testlist_comp;
    }
...
class TrailerContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = grammarPythonParser.RULE_trailer;
    }
	...
	DOT() {
	    return this.getToken(grammarPythonParser.DOT, 0);
	};
...
class SubscriptlistContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = grammarPythonParser.RULE_subscriptlist;
    }
...
class Subscript_Context extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = grammarPythonParser.RULE_subscript_;
    }
...
class SliceopContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = grammarPythonParser.RULE_sliceop;
    }
...
class ExprlistContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = grammarPythonParser.RULE_exprlist;
    }
...
class TestlistContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = grammarPythonParser.RULE_testlist;
    }
...
class DictorsetmakerContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = grammarPythonParser.RULE_dictorsetmaker;
    }
	...
	POWER = function(i) {
	    ...
	    if(i===null) {
	        return this.getTokens(grammarPythonParser.POWER);
	    } else {
	        return this.getToken(grammarPythonParser.POWER, i);
	    }
	};
...
class ClassdefContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = grammarPythonParser.RULE_classdef;
    }

	CLASS() {
	    return this.getToken(grammarPythonParser.CLASS, 0);
	};
...
class ArglistContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = grammarPythonParser.RULE_arglist;
    }
...
class ArgumentContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = grammarPythonParser.RULE_argument;
    }
...
class Comp_iterContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = grammarPythonParser.RULE_comp_iter;
    }
...
class Comp_forContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = grammarPythonParser.RULE_comp_for;
    }
...
class Comp_ifContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = grammarPythonParser.RULE_comp_if;
    }
...
class Encoding_declContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = grammarPythonParser.RULE_encoding_decl;
    }
...
class Yield_exprContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = grammarPythonParser.RULE_yield_expr;
    }

	YIELD() {
	    return this.getToken(grammarPythonParser.YIELD, 0);
	};
...
class Yield_argContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = grammarPythonParser.RULE_yield_arg;
    }
...
grammarPythonParser.Single_inputContext = Single_inputContext; 
grammarPythonParser.File_inputContext = File_inputContext; 
grammarPythonParser.Eval_inputContext = Eval_inputContext; 
grammarPythonParser.DecoratorContext = DecoratorContext; 
grammarPythonParser.DecoratorsContext = DecoratorsContext; 
grammarPythonParser.DecoratedContext = DecoratedContext; 
grammarPythonParser.Async_funcdefContext = Async_funcdefContext; 
grammarPythonParser.FuncdefContext = FuncdefContext; 
grammarPythonParser.ParametersContext = ParametersContext; 
grammarPythonParser.TypedargslistContext = TypedargslistContext; 
grammarPythonParser.TfpdefContext = TfpdefContext; 
grammarPythonParser.VarargslistContext = VarargslistContext; 
grammarPythonParser.VfpdefContext = VfpdefContext; 
grammarPythonParser.StmtContext = StmtContext; 
grammarPythonParser.Simple_stmtContext = Simple_stmtContext; 
grammarPythonParser.Small_stmtContext = Small_stmtContext; 
grammarPythonParser.Expr_stmtContext = Expr_stmtContext; 
grammarPythonParser.AnnassignContext = AnnassignContext; 
grammarPythonParser.Testlist_star_exprContext = Testlist_star_exprContext; 
grammarPythonParser.AugassignContext = AugassignContext; 
grammarPythonParser.Del_stmtContext = Del_stmtContext; 
grammarPythonParser.Pass_stmtContext = Pass_stmtContext; 
grammarPythonParser.Flow_stmtContext = Flow_stmtContext; 
grammarPythonParser.Break_stmtContext = Break_stmtContext; 
grammarPythonParser.Continue_stmtContext = Continue_stmtContext; 
grammarPythonParser.Return_stmtContext = Return_stmtContext; 
grammarPythonParser.Yield_stmtContext = Yield_stmtContext; 
grammarPythonParser.Raise_stmtContext = Raise_stmtContext; 
grammarPythonParser.Import_stmtContext = Import_stmtContext; 
grammarPythonParser.Import_nameContext = Import_nameContext; 
grammarPythonParser.Import_fromContext = Import_fromContext; 
grammarPythonParser.Import_as_nameContext = Import_as_nameContext; 
grammarPythonParser.Dotted_as_nameContext = Dotted_as_nameContext; 
grammarPythonParser.Import_as_namesContext = Import_as_namesContext; 
grammarPythonParser.Dotted_as_namesContext = Dotted_as_namesContext; 
grammarPythonParser.Dotted_nameContext = Dotted_nameContext; 
grammarPythonParser.Global_stmtContext = Global_stmtContext; 
grammarPythonParser.Nonlocal_stmtContext = Nonlocal_stmtContext; 
grammarPythonParser.Assert_stmtContext = Assert_stmtContext; 
grammarPythonParser.Compound_stmtContext = Compound_stmtContext; 
grammarPythonParser.Async_stmtContext = Async_stmtContext; 
grammarPythonParser.If_stmtContext = If_stmtContext; 
grammarPythonParser.While_stmtContext = While_stmtContext; 
grammarPythonParser.For_stmtContext = For_stmtContext; 
grammarPythonParser.Try_stmtContext = Try_stmtContext; 
grammarPythonParser.With_stmtContext = With_stmtContext; 
grammarPythonParser.With_itemContext = With_itemContext; 
grammarPythonParser.Except_clauseContext = Except_clauseContext; 
grammarPythonParser.SuiteContext = SuiteContext; 
grammarPythonParser.TestContext = TestContext; 
grammarPythonParser.Test_nocondContext = Test_nocondContext; 
grammarPythonParser.LambdefContext = LambdefContext; 
grammarPythonParser.Lambdef_nocondContext = Lambdef_nocondContext; 
grammarPythonParser.Or_testContext = Or_testContext; 
grammarPythonParser.And_testContext = And_testContext; 
grammarPythonParser.Not_testContext = Not_testContext; 
grammarPythonParser.ComparisonContext = ComparisonContext; 
grammarPythonParser.Comp_opContext = Comp_opContext; 
grammarPythonParser.Star_exprContext = Star_exprContext; 
grammarPythonParser.ExprContext = ExprContext; 
grammarPythonParser.Xor_exprContext = Xor_exprContext; 
grammarPythonParser.And_exprContext = And_exprContext; 
grammarPythonParser.Shift_exprContext = Shift_exprContext; 
grammarPythonParser.Arith_exprContext = Arith_exprContext; 
grammarPythonParser.TermContext = TermContext; 
grammarPythonParser.FactorContext = FactorContext; 
grammarPythonParser.PowerContext = PowerContext; 
grammarPythonParser.Atom_exprContext = Atom_exprContext; 
grammarPythonParser.AtomContext = AtomContext; 
grammarPythonParser.Testlist_compContext = Testlist_compContext; 
grammarPythonParser.TrailerContext = TrailerContext; 
grammarPythonParser.SubscriptlistContext = SubscriptlistContext; 
grammarPythonParser.Subscript_Context = Subscript_Context; 
grammarPythonParser.SliceopContext = SliceopContext; 
grammarPythonParser.ExprlistContext = ExprlistContext; 
grammarPythonParser.TestlistContext = TestlistContext; 
grammarPythonParser.DictorsetmakerContext = DictorsetmakerContext; 
grammarPythonParser.ClassdefContext = ClassdefContext; 
grammarPythonParser.ArglistContext = ArglistContext; 
grammarPythonParser.ArgumentContext = ArgumentContext; 
grammarPythonParser.Comp_iterContext = Comp_iterContext; 
grammarPythonParser.Comp_forContext = Comp_forContext; 
grammarPythonParser.Comp_ifContext = Comp_ifContext; 
grammarPythonParser.Encoding_declContext = Encoding_declContext; 
grammarPythonParser.Yield_exprContext = Yield_exprContext; 
grammarPythonParser.Yield_argContext = Yield_argContext; 
