...
export default class grammarPythonLexerBase extends antlr4.Lexer {
    constructor(input) {
        super(input);
        this.tokens = [];
        this.indents = [];
    ...
    nextToken() {
        ...
        if (this._input.LA(1) === grammarPythonParser.EOF && this.indents.length) {
            // Remove any trailing EOF tokens from our buffer.
            this.tokens = this.tokens.filter(function (val) {
                return val.type !== grammarPythonParser.EOF;
            });
            // First emit an extra line break that serves as the end of the statement.
            this.emitToken(this.commonToken(grammarPythonParser.NEWLINE, "\n"));
            ...
            this.emitToken(this.commonToken(grammarPythonParser.EOF, "<EOF>"));
        }
    ...
    createDedent() {
        return this.commonToken(grammarPythonParser.DEDENT, "");
    }
    ...
    onNewLine() {
        ...
        if (this.opened > 0 || (nextnext != -1 /* EOF */ && (next === 13 /* '\r' */ || next === 10 /* '\n' */ || next === 35 /* '#' */))) {
            ...
            this.emitToken(this.commonToken(grammarPythonParser.NEWLINE, newLine));
            ...
            if (indent === previous) {
                ...
                this.emitToken(this.commonToken(grammarPythonParser.INDENT, spaces));
            } else {
